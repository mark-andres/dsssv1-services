...
store_id, order_id, customer_id, address_id, distance, amount, order.created as created, order.comment as order_comment, delivered, requested_at, 
order_status_id, str, street_number, street, city, county, state_code, zip, unit, location_id, address.comment as address_comment, 
...
map_service_route
FROM `order`
JOIN phone_address USING (address_id)
